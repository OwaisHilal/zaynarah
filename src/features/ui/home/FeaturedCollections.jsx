// src/features/ui/home/FeaturedCollections.jsx
...
function CollectionCard({ title, img }) {
  return (
    <Link to="/shop" className="group">
      <div className="relative h-64 rounded-xl overflow-hidden shadow-lg transition-transform group-hover:scale-105">
